...
<body class="hold-transition login-page" style="background:url(img/knocknock.jpg); background-repeat:repeat; background-size:stretch; background-position:stretch;">
  <div class="row">
    <div class="col-md-6">
    </div>
    <div class="col-md-6">
        ...
        <div class="login-box-body" style="background-color: rgba(255,255,255,0.6);color: black;">
          ...
          <form action="pros_login.php" method="post">
            <div class="form-group has-feedback">
              <input id="user" type="text" name="user" class="form-control" placeholder="Id">
