$(document).ready(function() {
		...
		function loadContent(pi_address){
			var myFirebaseRef = new Firebase("https://nozcpanel.firebaseio.com/Controls");
				    ...
				    childSnapshot.forEach(function(nodeChildSnapshot) {
				    	...
				    	switch(node){
				    		...
				    		case "Lights":
				    			...
				    			break;
				    		case "Sensors":
				    			console.log(node_child_value.current_inside);
		...
		function loadPIInfo(){
			var myFirebaseRef = new Firebase("https://nozcpanel.firebaseio.com/PI");
			myFirebaseRef.on("value", function(snapshot) {
